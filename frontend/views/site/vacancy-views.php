    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="d-flex align-items-center">
                    <div class="border p-2 d-inline-block mr-3 rounded">
                        <img src="/jobboard/images/job_logo_5.jpg" alt="Image">
                    </div>
                    <div>
                        <h2><?=$vacancy->profession->name_uz?></h2>
                        <div>
                            <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span><?=$vacancy->company->name?></span>
                            <span class="m-2"><span class="icon-room mr-2"></span><?=$vacancy->address?></span>
                            <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-primary"><?=$vacancy->jobType->name_uz?></span></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-6">
                        <a href="#" class="btn btn-block btn-light btn-md"><span class="icon-heart-o mr-2 text-danger"></span><?=Yii::t('app','Save Job')?></a>
                    </div>
                    <div class="col-6">
